  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 5
      h1 Contexto, tipo y características de los alojamientos para los diferentes sistemas productivos de las aves
    ...
    .col-xl-10.mx-auto.mb-5(data-aos="fade-right")
      .col-sm.mb-5.mb-sm-0
        ul.lista-ul--color
          li 
            i.fas.fa-egg
            | <strong>Vías de acceso:</strong> que estén relativamente cerca al lugar de producción, con carreteras que permitan la salida y entrada de vehículos y personal, pero que cumplan con el cerco perimetral que exige la normatividad por cuestiones de bioseguridad.
          li 
            i.fas.fa-egg
            | <strong>Electrificación y agua potable:</strong> dos aspectos necesarios para establecer cualquier tipo de producción, más aún de tipo pecuario, donde los animales requieren el flujo constante del recurso hídrico, al igual que el proceso productivo.
          li 
            i.fas.fa-egg
            | <strong>Aprovechar la presencia de árboles:</strong> los árboles sirven como barrera ambiental para prevenir los vientos fuertes.
          li 
            i.fas.fa-egg
            | <strong>Separación entre granjas por control sanitario</strong> (Lascarro, 2014).
          li 
            i.fas.fa-egg
            | <strong>Separación entre galpones:</strong> 2 veces el ancho del galpón (Lascarro, 2014).
    ...
    .d-flex.flex-wrap.mb-5
      ...
      img.mb-4.mb-xl-0.col-xl-4.mx-auto.order-1.order-xl-2(src="@/assets/curso/temas/tema5/img-41.svg" data-aos="fade-right")
      ...
      .col-12.col-md-7(data-aos="fade-left")
        .col-sm.mb-5.mb-sm-0
          ul.lista-ul--color
            li 
              i.fas.fa-egg
              | <strong>En climas fríos y templados,</strong> es decir, con temperaturas entre 15 y 20º C, el eje largo del galpón o caballete debe estar en dirección norte-sur, esto para lograr mejores temperaturas dentro del galpón (González, 2021).
            li 
              i.fas.fa-egg
              | <strong>En climas calientes,</strong> o sea con temperaturas mayores de 20º C, el eje del galpón o caballete debe estar ubicado de oriente a occidente, para disminuir el calentamiento del galpón (González, 2021).
    ...
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-5(data-aos="fade-right")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema5/img-43.png')})`}"
      )
    ...
    .titulo-segundo.color-acento-contenido(data-aos="fade-right")
      h3#t_1_1 5.4.2 Ancho, largo y alto.
    ...
    img.mb-5(src="@/assets/curso/temas/tema5/img-46.svg")(data-aos="fade-right")
    ...
    .row.mb-5
      .col-12.col-md-5.mb-3.mb-md-0(data-aos="fade-right")
        figure
          img(src='@/assets/curso/temas/tema5/img-46.svg', alt='Texto que describa la imagen')
      .col-12.col-md-7(data-aos="fade-left")
    ...
    .titulo-segundo.color-acento-contenido(data-aos="fade-right")
      h3#t_1_1 5.5.1 Clases de techos.
    ...
    .tarjeta.tarjeta--azul2.p-4.mb-5
      SlyderA(tipo="b")
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema5/img-47.svg', alt='Texto que describa la imagen')

        .row
          .col-md-6.mb-4.mb-md-0
            h4 Techo de dos aguas cerrado:
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema5/img-48.svg', alt='Texto que describa la imagen')

        .row
          .col-md-6.mb-4.mb-md-0
            h4 Techo de dos aguas asimétrico:
            p Brinda una adecuada ventilación y ayuda en la evaporación de los gases por la parte  superior. Dado lo anterior, es bueno para climas cálidos, pero tiene la desventaja que, al momento de llover con vientos fuertes, tiene la posibilidad de que el agua pueda entrar por el desnivel superior. (Gonzalez, 2018).

          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema5/img-49.svg', alt='Texto que describa la imagen')

        .row
          .col-md-6.mb-4.mb-md-0
            h4 Techo dos aguas con claraboya:
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema5/img-50.svg', alt='Texto que describa la imagen')
    ...
    .titulo-segundo.color-acento-contenido(data-aos="fade-right")
      h3#t_1_1 5.5.2 Materiales de construcción techos.
    
    p Los techos pueden estar construidos en diversos materiales, dependiendo del sistema productivo, el clima, la disponibilidad y los costos. Estos pueden ser en lámina de zinc, Eternit, teja de barro, cobertizos naturales, etc. En el siguiente video, se pueden apreciar algunos de ellos.
